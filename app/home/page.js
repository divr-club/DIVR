    ...
    <div className="home-page">
      ...
      <div className="home-wrapper">
        ...
        <div className="home-stats-grid">
          ...
          <div className="home-stat-card">
            <h2>{profile?.certification || "Open Water"}</h2>
            <p>Certification</p>
          </div>
            ...
            >
              ...
              <div className="upcoming-dive-top">
                ...
                <span className="spots-left">
                  {nextDive.spots || 0} spots left
                </span>

              </div>

              <h3>{nextDive.title}</h3>
              ...
              <div className="dive-date">
                {new Date(nextDive.date).toLocaleString("en-GB", {
                  weekday: "short",
                  day: "numeric",
                  month: "short",
                  hour: "2-digit",
